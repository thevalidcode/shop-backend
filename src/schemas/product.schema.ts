...
export const ProductCreateInputSchema = z.object({
  ...
  supplierPrice: z.coerce.string().optional(),
  supplierProductUid: z.string().optional(),
  supplierUid: z.string().optional(),
  supplierCurrency: z.string().toUpperCase().length(3).optional(),
  ...
  marginValue: z.coerce.string().optional(),
...
export const ProductUpdateInputSchema = z.object({
  ...
  supplierPrice: z.coerce.string().nullable().optional(),
  supplierProductUid: z.string().nullable().optional(),
  supplierUid: z.string().nullable().optional(),
  supplierCurrency: z.string().toUpperCase().length(3).nullable().optional(),
  syncWithSupplier: z.boolean().optional(),
  syncQuantity: z.boolean().optional(),
  syncCatAndName: z.boolean().optional(),
  marginType: z.enum(["percentage", "fixed"]).nullable().optional(),
  marginValue: z.coerce.string().nullable().optional(),
  position: z.number().optional(),
