...
const OrderItemResponseSchema = z.object({
  ...
  product: z.object({
    ...
    imageUrl: z
      .string()
      .nullable()
      .openapi({ example: "https://example.com/headphones.jpg" }),
  }),
});

// Shipping Information in Order Response
const ShippingInfoInOrderSchema = z.object({
...
export const OrderResponseSchema = z.object({
  ...
  shippingInfo: ShippingInfoInOrderSchema,
});
