...
exports.newMessage = exports.newSupport = void 0;
const newSupport = ({ id, subject, user, message, logo, }) => `
  <!DOCTYPE html>
  <html lang="en">
  <head>
    <meta charset="UTF-8">
  ...
  <body>
    <div class="container">
      ...
      <div class="content">
        ...
        <p>Please review and respond to the ticket in the admin shop.</p>
        <p>Thank you!</p>
      </div>
    </div>
  </body>
...
`;
exports.newSupport = newSupport;
const newMessage = ({ ticket_id, user, content, logo, }) => `
  <!DOCTYPE html>
  <html lang="en">
  <head>
    <meta charset="UTF-8">
  ...
  <body>
    <div class="container">
      ...
      <div class="content">
        ...
        <p>Please log in to the admin shop to review and respond to the message.</p>
        <p>Thank you!</p>
      </div>
    </div>
  </body>
